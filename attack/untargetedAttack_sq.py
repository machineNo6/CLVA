...
from attack.attack_utils_sq import untargeted_video_attack, \
    untargeted_video_attack_m ,square_attack_linf, \
        square_attack_linf_targeted    # attack method
...
def attack_sq(vid_model,vid,target_label, masklist, class_no):

    res, iter_num, adv_vid =square_attack_linf_targeted(vid_model,vid,target_label,0.05,60000,0.01, masklist, class_no)
    # attack state，iterations，adversary
    return res, iter_num,adv_vid